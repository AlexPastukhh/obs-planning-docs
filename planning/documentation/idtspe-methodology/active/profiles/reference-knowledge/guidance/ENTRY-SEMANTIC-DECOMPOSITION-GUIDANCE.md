...
Generic destination/identity tests in this file remain valid even when no Domain Pack exists. When one or more concrete packs are installed and materially applicable, use their subject-specific guidance through the [Domain Pack Registry](../DOMAIN-PACK-REGISTRY.md#reference-knowledge-domain-pack-registry).
