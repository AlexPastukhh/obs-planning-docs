...
This syntax is a representation choice, not a new Core semantic type. Tag Assignments and Entry Relations have composite semantic identity as defined by [Vocabulary Model](VOCABULARY-MODEL.md#vocabulary-model); implementations may add storage row IDs without making them profile-level identity.
