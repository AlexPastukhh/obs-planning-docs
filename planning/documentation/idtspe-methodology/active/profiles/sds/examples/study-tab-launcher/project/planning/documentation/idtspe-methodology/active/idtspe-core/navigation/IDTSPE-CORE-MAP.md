...
Canonical routing ownership: Documentation [`UC-DOC-RESOLVE-CURRENT-USE-CASES`](../../../../../../../source-context/planning/documentation/use-cases/UC-DOC-RESOLVE-CURRENT-USE-CASES.md), [`principles-and-terminology.md`](../../../../../../../source-context/planning/documentation/principles-and-terminology.md), [`use-case-registry-map.md`](../../../../../../../source-context/planning/documentation/use-case-registry-map.md), Core [`UC-IDTSPE-AI-WORKING-BOUNDARY`](../use-cases/ai-working-boundary/UC-IDTSPE-AI-WORKING-BOUNDARY.md), and [`UC-IDTSPE-COMPOSE-CURRENT-WORK`](../use-cases/compose-current-work/UC-IDTSPE-COMPOSE-CURRENT-WORK.md).
