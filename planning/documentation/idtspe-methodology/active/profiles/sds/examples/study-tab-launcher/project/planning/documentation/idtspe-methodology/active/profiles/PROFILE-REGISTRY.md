...
Every profile bootstrap is incremental. It assumes the primary bootstrap from [`planning/README.md`](../../../../../../source-context/planning/README.md) has already established Session, Documentation and IDTSPE Core. A profile `README.md` owns its own profile read set; installed-profile navigation does not duplicate it here.
