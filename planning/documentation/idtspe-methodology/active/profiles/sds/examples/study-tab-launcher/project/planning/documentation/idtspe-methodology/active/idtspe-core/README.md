...
This `README.md` is the canonical Core bootstrap entry. If the generic planning bootstrap is not already reliable, first bootstrap from [`planning/README.md`](../../../../../../source-context/planning/README.md), then return here.
...
- direct IDTSPE command-surface semantics / owner-derived command→port composition → [`commands/IDTSPE-COMMAND-SURFACE-CONTRACT.md`](commands/IDTSPE-COMMAND-SURFACE-CONTRACT.md#idtspe-command-surface); repository command/Helper routing remains outside Core at [`../../../../commands/RESPONSIBILITY-MAP.md`](../../../../../../source-context/planning/commands/RESPONSIBILITY-MAP.md);
...
Methodology work starts from Use Cases. Canonical cross-scope routing semantics belong to Documentation [`principles-and-terminology.md`](../../../../../../source-context/planning/documentation/principles-and-terminology.md) and the [`Methodology Use-Case Registry Map`](../../../../../../source-context/planning/documentation/use-case-registry-map.md).
