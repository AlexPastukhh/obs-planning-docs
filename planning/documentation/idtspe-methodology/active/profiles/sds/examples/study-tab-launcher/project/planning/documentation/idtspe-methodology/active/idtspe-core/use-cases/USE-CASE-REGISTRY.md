...
This registry is reached by the fundamental [`UC-DOC-RESOLVE-CURRENT-USE-CASES`](../../../../../../../source-context/planning/documentation/use-cases/UC-DOC-RESOLVE-CURRENT-USE-CASES.md) through the generic [`Methodology Use-Case Registry Map`](../../../../../../../source-context/planning/documentation/use-case-registry-map.md). It governs **how IDTSPE methodology is composed/used**, not the specialized planning semantics owned by Target Modules/Lenses/profiles.

> Semantic Owner Dependency
> Type: REPRESENTS
> Responsibility: `DOC.USE-CASE-APPLICABILITY-RESOLUTION`
> Owner: [`UC-DOC-RESOLVE-CURRENT-USE-CASES`](../../../../../../../source-context/planning/documentation/use-cases/UC-DOC-RESOLVE-CURRENT-USE-CASES.md)
...
- Resolution Carry-Forward projection ([`planning/documentation/idtspe-methodology/active/idtspe-core/resolution/continuation/RESOLUTION-CARRY-FORWARD-PROJECTION.md`](../resolution/continuation/RESOLUTION-CARRY-FORWARD-PROJECTION.md)) for material continuation/handoff routing;
- consistency review;
- registry traversal;
