...
- [`active/`](active/README.md) — current operational methodology.
- [`integration/`](integration/README.md) — repository-specific migration/integration projections; not methodology authority.
- [`sources-readonly/`](sources-readonly/README.md) — frozen provenance/superseded material; not current authority.
