...
Generic Documentation semantics for a `Responsibility Map` are owned by [`../../principles-and-terminology.md`](../../../../../../source-context/planning/documentation/principles-and-terminology.md).

| Responsibility | Current canonical owner | Important projection / supporting owner |
|---|---|---|
| Documentation semantic roles (`README`, Use Case, Responsibility Map, etc.) | [`../../principles-and-terminology.md`](../../../../../../source-context/planning/documentation/principles-and-terminology.md) | Concrete responsibility maps own routing rows only; destination owners own semantic bodies |
...
| Planning Resolution State coordination Target | [`idtspe-core/target-modules/TM-PLANNING-RESOLUTION-STATE.md`](../idtspe-core/target-modules/TM-PLANNING-RESOLUTION-STATE.md#tm-planning-resolution-state) — `TM-PLANNING-RESOLUTION-STATE` | Active Planning and Tracked Decisions only; Carry-Forward is its continuation projection |
...
| Generic IDTSPE command surface / command→Use-Case/component→port-composition handshake | [`idtspe-core/commands/IDTSPE-COMMAND-SURFACE-CONTRACT.md`](../idtspe-core/commands/IDTSPE-COMMAND-SURFACE-CONTRACT.md#idtspe-command-surface) — `IDTSPE.COMMAND-SURFACE` | repository command/helper ownership routes through [`../../../../commands/RESPONSIBILITY-MAP.md`](../../../../../../source-context/planning/commands/RESPONSIBILITY-MAP.md) |
