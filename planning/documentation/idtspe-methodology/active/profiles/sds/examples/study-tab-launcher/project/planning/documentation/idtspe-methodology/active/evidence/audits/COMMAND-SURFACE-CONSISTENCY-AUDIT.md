...
- generic Core command owner: `idtspe-core/commands/IDTSPE-COMMAND-SURFACE-CONTRACT.md`
- SDS extension owner: `profiles/sds/commands/SDS-COMMAND-SURFACE-EXTENSION.md`
