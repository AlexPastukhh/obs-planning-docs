...
| Planning Resolution State coordination/result shape | [`../target-modules/TM-PLANNING-RESOLUTION-STATE.md`](../target-modules/TM-PLANNING-RESOLUTION-STATE.md#tm-planning-resolution-state) | Two Collection Units; lifecycle/accepted owner content remain at their natural owners |
