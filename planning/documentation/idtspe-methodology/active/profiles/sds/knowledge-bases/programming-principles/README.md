...
- [`planning/documentation/idtspe-methodology/active/profiles/sds/knowledge-bases/programming-principles/guidance/design-and-structure.md`](guidance/design-and-structure.md) — complexity, semantic contracts, cohesion, dependencies, encapsulation, abstraction, KISS/YAGNI, composition.
- [`planning/documentation/idtspe-methodology/active/profiles/sds/knowledge-bases/programming-principles/guidance/state-failure-and-execution.md`](guidance/state-failure-and-execution.md) — state, failure, retries, concurrency, resources, determinism/time/identity, bounded/cancellable work.
- [`planning/documentation/idtspe-methodology/active/profiles/sds/knowledge-bases/programming-principles/guidance/trust-observability-quality.md`](guidance/trust-observability-quality.md) — authority/trust, diagnostics, testability/refactoring, performance/capacity.
- [`planning/documentation/idtspe-methodology/active/profiles/sds/knowledge-bases/programming-principles/guidance/interfaces-boundaries-and-evolution.md`](guidance/interfaces-boundaries-and-evolution.md) — interface/substitutability, boundary validation/normalization, compatibility/versioning/migration.
...
The reusable authority/no-live-inheritance rule is defined by [`../planning/documentation/idtspe-methodology/active/profiles/sds/profile-contracts/reusable-guidance/REUSABLE-GUIDANCE-MODEL.md`](../../profile-contracts/reusable-guidance/REUSABLE-GUIDANCE-MODEL.md).
