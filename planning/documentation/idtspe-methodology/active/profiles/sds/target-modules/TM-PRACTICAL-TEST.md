...
Shared inquiry/collection mechanics are owned by [`Practical Evidence Method`](../../../idtspe-core/knowledge-bases/PRACTICAL-EVIDENCE.knowledge-basis.md); this module should not duplicate that method.
...
3. **Closing Unit Checkpoint — `RU-PTEST-03`** — evaluate the actual candidate Unit result, disposition material Findings/owner consequences, and reopen/refine narrowly when needed before treating the Unit as current-for-handoff.
