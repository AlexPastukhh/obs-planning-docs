...
| 15 | [Visual Material Preparation](target-modules/TM-2D-15-VISUAL-MATERIAL-PREPARATION.md#tm-2d-15-visual-material-preparation) | `TM-2D-15-VISUAL-MATERIAL-PREPARATION` | PRIMARY / SUPPORTING / re-entrant | prepare qualified visual material / Source Subjects |
...
For the semantic route-selection guidance, use [Construction Route Selection Guidance](shared/CONSTRUCTION-ROUTE-SELECTION.md#shared-construction-route-selection).
