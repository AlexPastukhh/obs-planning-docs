...
- profile-specific runtime/orchestration semantics that are owned inside SDS, Visual Production 2D or Reference Knowledge rather than by generic Core; those remain for the profile pass;
