...
- these Lens/AP/AG counts are intentionally the Part-2 snapshot; see `evidence/audits/FINAL-METHODOLOGY-AUDIT.md` for current installed totals: **PASS boundary**
