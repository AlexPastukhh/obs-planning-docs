...
| Planning Resolution State coordination Target | [`idtspe-core/target-modules/TM-PLANNING-RESOLUTION-STATE.md`](../idtspe-core/target-modules/TM-PLANNING-RESOLUTION-STATE.md#tm-planning-resolution-state) — `TM-PLANNING-RESOLUTION-STATE` | One PRS result: Active Planning and Decisions with qualifying Q/R/P; Carry-Forward separately owns continuation qualification/admission/exit while PRS owns the concrete result shape |
...
| Current Target Module/Lens declared semantic-dependency projection and reverse-impact lookup | [`TARGET-MODULE-LENS-DEPENDENCY-MAP.md`](TARGET-MODULE-LENS-DEPENDENCY-MAP.md#idtspe-tm-lens-dependency-map) — `IDTSPE.TM-LENS-DEPENDENCY-PROJECTION` | Projection only; concrete TM/Lens `Semantic Owner Dependency` declarations remain normative and integrity is owned by [`TARGET-MODULE-LENS-DEPENDENCY-MAP-INTEGRITY.md`](TARGET-MODULE-LENS-DEPENDENCY-MAP-INTEGRITY.md#idtspe-tm-lens-dependency-projection-integrity) |
