...
| Planning Resolution State coordination Target | [`idtspe-core/target-modules/TM-PLANNING-RESOLUTION-STATE.md`](../idtspe-core/target-modules/TM-PLANNING-RESOLUTION-STATE.md#tm-planning-resolution-state) — `TM-PLANNING-RESOLUTION-STATE` | One PRS/RCF result: Active Planning and Decisions with qualifying Q/R/P; membership, linked context, order and continuation materialization |
