...
| USER-input classification into Source / Answer / Need / Proposal / Decision | [`idtspe-core/runtime/interaction/USER-INPUT-DECISION-AND-ANSWER-INTAKE-RULE.md`](../idtspe-core/runtime/interaction/USER-INPUT-DECISION-AND-ANSWER-INTAKE-RULE.md) | resolution owners consume classification; intake does not redefine their lifecycles |
