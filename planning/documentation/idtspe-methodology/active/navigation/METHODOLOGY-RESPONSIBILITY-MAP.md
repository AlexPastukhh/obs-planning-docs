...
| SDS profile semantics / Target Modules / Lenses / requirements / knowledge / representation | [`profiles/sds/RESPONSIBILITY-MAP.md`](../profiles/sds/RESPONSIBILITY-MAP.md) | child map routes concrete SDS owners and explicitly reserves command-surface composition for the final command audit |
