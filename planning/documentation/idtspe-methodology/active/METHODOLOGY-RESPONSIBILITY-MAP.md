...
| USER-input classification into Source / Answer / Proposal / Decision | [`idtspe-core/shared/user-input-decision-and-answer-intake-rule.md`](idtspe-core/shared/user-input-decision-and-answer-intake-rule.md) | Proposal/Decision Lens consumes classification; it does not redefine intake |
...
| accepted-Decision revalidation helper/projection | [`idtspe-core/shared/decision-revalidation-helper-model.md`](idtspe-core/shared/decision-revalidation-helper-model.md) | helper projection only; accepted Decision semantics stay lifecycle-owned |
| open/deferred/residual continuation routing projection | [`idtspe-core/shared/resolution-carry-forward-projection-contract.md`](idtspe-core/shared/resolution-carry-forward-projection-contract.md) | compact refs/status only; canonical bodies remain at natural owners |
