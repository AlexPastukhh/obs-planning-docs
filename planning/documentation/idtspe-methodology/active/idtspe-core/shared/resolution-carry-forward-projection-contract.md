...
Physical representation is chosen by [`artifact-placement-and-idtspe-response-contract.md`](artifact-placement-and-idtspe-response-contract.md). Valid outcomes include inline checkpoint subsection, existing coordination artifact/register, generated projection or no separate persistence when continuation value is transient.
