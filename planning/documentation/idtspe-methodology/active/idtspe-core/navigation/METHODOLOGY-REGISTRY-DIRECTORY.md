...
| Target Module / Lens Dependency Map | which current TM/Lens materially depends on which semantic owner, and which components require revalidation after owner change | dependency/revalidation impact across current Target Modules/Lenses is being reviewed | declared dependency projection + direct TM/Lens topology | [`../../navigation/TARGET-MODULE-LENS-DEPENDENCY-MAP.md`](../../navigation/TARGET-MODULE-LENS-DEPENDENCY-MAP.md#idtspe-tm-lens-dependency-map) | any current TM/Lens `Semantic Owner Dependency`, owner path/anchor or component inventory changes |
