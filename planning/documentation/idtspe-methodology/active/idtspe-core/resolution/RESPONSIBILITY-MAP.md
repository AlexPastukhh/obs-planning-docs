...
|---|---|---|
| Need Candidate grounding/disposition before solution/owner/temporal home is known | [`NEED-CANDIDATE-DISPOSITION.md`](needs/NEED-CANDIDATE-DISPOSITION.md#resolution-need-candidate-disposition) — `RESOLUTION.NEED-CANDIDATE-DISPOSITION` | Intake/disposition boundary only; accepted meaning moves to the selected existing owner/lifecycle |
...
| Open/deferred/residual continuation/handoff routing projection | [`RESOLUTION-CARRY-FORWARD-PROJECTION.md`](continuation/RESOLUTION-CARRY-FORWARD-PROJECTION.md#resolution-carry-forward) — `RESOLUTION.CARRY-FORWARD` | Compact navigation/status/reference aggregate only; canonical Proposal/Decision/Q/R/P/Evidence/Result bodies remain at natural owners |
