...
| Resolution Carry-Forward qualification / Decision admission-exit / durable continuation threshold | [`RESOLUTION-CARRY-FORWARD-CONTRACT.md`](RESOLUTION-CARRY-FORWARD-CONTRACT.md#resolution-carry-forward) — `RESOLUTION.CARRY-FORWARD` | Generic continuation contract only; consumes Proposal/Decision + Q/R/P lifecycle semantics and does not prescribe a Target Module/file shape. |
| Planning Resolution State bounded Target-result schema | [`TM-PLANNING-RESOLUTION-STATE.md`](../target-modules/TM-PLANNING-RESOLUTION-STATE.md#tm-planning-resolution-state) — `TARGET-MODULE.PLANNING-RESOLUTION-STATE` | Concrete reusable Core realization of Carry-Forward: two Collection Units, item addressing, presentation/composition and PRS-local reconciliation. |
