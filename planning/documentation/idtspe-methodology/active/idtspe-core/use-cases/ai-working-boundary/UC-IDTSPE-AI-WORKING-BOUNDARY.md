...
> - `CONTEXTUALIZES` [`AI Working Contract`](../../../../../../AI-WORKING-CONTRACT.md#planning-ai-working-contract) — `PLANNING.AI-WORKING-CONTRACT`
> - `CONTEXTUALIZES` [`Session Runtime Contract`](../../../../../../session/session-runtime-contract.md#session-runtime-contract) — `SESSION.RUNTIME-CONTRACT`
