...
| Fundamental AI working authority-boundary orchestration | [`ai-working-boundary/UC-IDTSPE-AI-WORKING-BOUNDARY.md`](ai-working-boundary/UC-IDTSPE-AI-WORKING-BOUNDARY.md#uc-idtspe-ai-working-boundary) — `IDTSPE.UC.AI-WORKING-BOUNDARY` | Always-active companion of the cross-scope applicability resolver; invokes canonical AI/Session/Proposal owners without duplicating their rules or creating an AI command mode |
