...
| One Planning Resolution State / RCF result with Active Planning and Q/R/P-qualified Tracked Decision Collections | [`TM-PLANNING-RESOLUTION-STATE.md`](TM-PLANNING-RESOLUTION-STATE.md#tm-planning-resolution-state) | Coordination/result shape only; candidate/selection and Q/R/P lifecycle stay with Resolution owners |
