...
| [`TM-SLICE-STRATEGY.md`](active/profiles/sds/target-modules/TM-SLICE-STRATEGY.md) | Slice Implementation Strategy: vertical Slice portfolio/Behavior realization, broad/shallow Domain/Aggregate realization map, and stable selected Slice semantic identity/addressability. |
