...
| Repeated whole-solution → detailed application process | `solution-and-scenario-planning-workflow.md` |
...
A detailed workspace folder is physical organization only. It does not become a registered parallel-work scope or receive its own `action-log.md` unless the project Scope Registry explicitly says so.
