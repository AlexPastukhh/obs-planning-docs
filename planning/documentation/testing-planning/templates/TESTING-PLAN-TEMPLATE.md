...
Status: historical compatibility template; not a current methodology owner
Scope: preserved shape for an older project-local testing plan. `UC-PLAN-TEST-PLAN` is retired/subsumed; current operated proof routes through the applicable natural owner, Core Test-Proof Lens, and conditional Practical Test. This template does not establish a separate current Testing Plan result or product-behavior authority.
...
- Stored At / Q/R/P register/index — when applicable:
