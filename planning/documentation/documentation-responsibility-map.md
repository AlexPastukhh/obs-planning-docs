...
| SDS owner/file representation examples and promotion/demotion pressure | `idtspe-methodology/active/profiles/sds/ARTIFACT-PLACEMENT-MAP.md` |
| Canonical SDS semantic profile / Target-owner routing | `idtspe-methodology/active/profiles/sds/README.md` + Target/Lens registries |
