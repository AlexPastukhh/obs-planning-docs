...
| Documentation preflight | `documentation-principles-read-workflow.md` |
...
| Shared Idea methodology | Idea principles/workflow/template |
...
6. does navigation/registry/coverage need synchronization?
7. if a command is involved, is it only an executable shortcut to a semantic capability?
