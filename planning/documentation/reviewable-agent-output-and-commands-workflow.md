...
Current cross-cutting AI answer reviewability and directed-planning semantics are owned by [`idtspe-methodology/active/ai-reviewability/AI-OUTPUT-REVIEWABILITY.md`](idtspe-methodology/active/ai-reviewability/AI-OUTPUT-REVIEWABILITY.md). The former Level 1/2/3 answer model and `обс`-as-quality-mechanism are retired.
