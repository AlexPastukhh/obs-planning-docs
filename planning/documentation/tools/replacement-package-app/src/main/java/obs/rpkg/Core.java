...
public final class Core {
    ...
    private final GitClient git=new GitClient(); private final StateStore state; private final ClipboardAccess clipboard; private final ChatBridgeService chatBridge; private Runnable afterMutationHook=()->{},afterPublishAttemptHook=()->{}; private java.util.function.Consumer<String> afterRecoveryPathCleanHook=path->{};
