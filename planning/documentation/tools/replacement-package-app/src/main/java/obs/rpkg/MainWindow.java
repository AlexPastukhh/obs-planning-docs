...
final class MainWindow extends JFrame {
    ...
    private void run(String label,Runnable r){try{r.run();}catch(Core.ObsException e){append("["+e.code+"] "+e.getMessage());}catch(Exception e){append(withTechnicalDetails("ERROR Unexpected "+label+" failure: "+message(e),e));}}
