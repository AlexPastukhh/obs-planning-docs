...
Status: active methodology routing owner  
...
**Do not use for:** unselected design alternatives → 07; Screen spatial truth → 11; durable implementation HOW → 02/03/04/05.  
**Related:** 02, 03, 05, 07, 08, 09, 11, 12.
...
**Do not use for:** deriving ontology from classes; Slice orchestration → 03; broad evolution pressure → 05; exact source mechanics → 06.  
**Related:** 01, 03, 05, 06, 12.
...
**Do not use for:** redefining Scenario behavior; forcing FI=Slice; Domain invariants → 02; call-chain documentation → 06.  
**Related:** 01, 02, 04, 05, 06, 12.
...
**Do not use for:** defining WHAT evolution changes → 01; planning WHEN/order/readiness → 08; prematurely implementing future behavior.  
**Related:** 01, 02, 03, 04, 08, 12.
...
**Do not use for:** routine selected Scenario maintenance → 01; selected Screen maintenance → 11; treating rejected alternatives as current truth.  
**Related:** 01, 06, 09, 11.
...
**Do not use for:** redefining WHAT a step changes → 01; duplicating lower-owner Impact; encoding roadmap order in semantic IDs.  
**Related:** 01, 05, 09.
...
**Do not use for:** document-level size/cohesion → 13; deciding semantic ownership → 10.  
**Related:** 10, 13 and the owner-specific UC whose output is being written.
...
**Do not use for:** treating every file as an owner or requiring a new owner because one file is large; physical decomposition → 13.  
**Related:** 09, 13 and the application process that justifies the semantic owner.
...
**Do not use for:** Scenario/FI behavioral authority → 01; treating Screens as frontend Slices; unselected alternatives → 07.  
**Related:** 01, 07, 08, 09.
...
**Do not use for:** creating semantic owners merely because a file is large, splitting solely by line count, or deciding new semantic authority → 10.  
**Related:** 09, 10 and the owner-specific UC for the content being decomposed.
