...
public record IssueEditVerification(boolean actorTextMatches, boolean managedIdentityMatches) {
        public boolean valid() { return actorTextMatches && managedIdentityMatches; }
    }
