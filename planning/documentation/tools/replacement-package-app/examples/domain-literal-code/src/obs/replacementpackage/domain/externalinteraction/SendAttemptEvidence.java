...
public record SendAttemptEvidence(ArtifactFingerprint artifact, ConversationKey destination) {
        public SendAttemptEvidence { Objects.requireNonNull(artifact); Objects.requireNonNull(destination); }
    }
