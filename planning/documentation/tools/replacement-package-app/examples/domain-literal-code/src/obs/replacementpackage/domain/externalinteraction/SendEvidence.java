...
public record SendEvidence(ArtifactFingerprint artifact, ConversationKey destination) {
        public SendEvidence { Objects.requireNonNull(artifact); Objects.requireNonNull(destination); }
    }
