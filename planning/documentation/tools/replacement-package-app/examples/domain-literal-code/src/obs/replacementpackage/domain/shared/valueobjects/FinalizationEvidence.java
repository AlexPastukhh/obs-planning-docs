...
public record FinalizationEvidence(boolean integrationProven, boolean finalCommentProven) {
        public boolean complete() { return integrationProven && finalCommentProven; }
    }
