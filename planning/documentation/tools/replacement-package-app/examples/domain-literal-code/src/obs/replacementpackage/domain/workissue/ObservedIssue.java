...
public record ObservedIssue(ManagedWorkIdentityText managedIdentity, ActorIssueText actorText) {
        public ObservedIssue { Objects.requireNonNull(managedIdentity); Objects.requireNonNull(actorText); }
    }
