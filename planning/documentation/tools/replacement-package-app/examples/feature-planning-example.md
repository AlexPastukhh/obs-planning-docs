# Practical Feature Example — Start Repository Work

Status: methodology example only; not a second behavioral authority.

This example demonstrates the compact Feature form: Data, Main path rows, BR identity + short logical statement, decision columns, and explicit convergence. The product authority is the Builder Feature owner.
