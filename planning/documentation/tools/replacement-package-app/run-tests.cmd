...
java -cp "build\classes;build\test-classes" obs.rpkg.PackageProtocolTests || exit /b 1
java -cp "build\classes;build\test-classes" obs.rpkg.features.apply.PackageApplicabilityTests || exit /b 1
