...
**Trigger/input:** local direct Command/Prompt create/edit/delete, Favorite toggle, command presentation-group change, **Manage groups** create/rename/reorder/delete, group filter selection, group collapse/expand, panel drag or resize.
