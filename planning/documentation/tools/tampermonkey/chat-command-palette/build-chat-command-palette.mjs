...
const sourceFiles=[
  'src/command-definition-codec.js','src/command-catalog.js','src/command-body.js','src/semantic-projections.js','src/github-contents-client.js','src/repository-command-service.js','src/planning-helper-state.js','src/composer-insertion.js','src/planning-helper-ui.js','src/planning-helper-runtime.js'
];
