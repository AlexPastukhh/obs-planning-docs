...
- moved current Linked Notes semantic ownership into local `scenarios/README.md` / `USE-CASE-REGISTRY.md`, added a local roadmap, and downgraded former Documentation Workbench Linked Notes workflow owners to legacy planning/compatibility context;
