...
Scope design is informed by current semantic ownership: independently coordinated scopes should normally follow cohesive broad work families when practical, without forcing a 1:1 mapping to Use Cases, Scenarios or registry groups. Semantic owners remain semantic authority; this Scope Registry remains physical coordination-boundary authority.
