...
[PLANNING_COMMAND_DEFINITION]
{
  ...
  "meaning": "Run the SDS governance bootstrap over IDTSPE Core: establish or refresh the 17 Target Modules, SDS Lens pack, directed workflow and representation/materialization policy. This is governance bootstrap, not selection of the Full SDS profile and not task-specific planning execution.",
