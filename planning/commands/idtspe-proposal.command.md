...
[PLANNING_COMMAND_DEFINITION]
{
  ...
  "meaning": "Apply the Session USER-gated proposal-driven interaction policy and compose the current IDTSPE Work Context through canonical Core Proposal/Decision, USER-input intake and Q/R/P lifecycle semantics. Before presenting a material formal or conversational Proposal, resolve any genuinely required USER-only grounding through the minimum useful clarification; then form/review the Proposal. Material candidate Unit/Target/owner meaning remains Proposal until selected through the canonical lifecycle; material unresolved Question/Risk/Problem meaning remains governed by the Q/R/P owner. This command creates no parallel Proposal, Decision or Q/R/P semantics.",
  "activeContextBehavior": "Use the current Work Context and re-evaluate UC-IDTSPE-COMPOSE-CURRENT-WORK proportionally. Reuse available Sources/USER input first; when a material USER-only grounding gap would materially change the candidate, ask the minimum useful clarification and intake the answer before presenting the affected Proposal. Express material candidate meaning as formal IDTSPE Proposal State only when lifecycle/addressability/review is useful, link material Q/R/P through their canonical owner, perform proportional candidate review, and wait for USER selection at material gates. Selected meaning then flows to its normal planning destination; under SDS, unrealized selected future meaning remains in the applicable Evolution Step/Target Body until realization/materialization rather than becoming current-owner truth merely by selection.",
  ...
  "expectedOutput": "Current useful IDTSPE work is USER-gated and represented canonically: required USER-only grounding is clarified before the affected material Proposal, material candidate meaning remains Proposal until selected, relevant Q/R/P remains linked through its lifecycle, and selected meaning is integrated into the correct planning/current destination without treating selection as realization.",
  ...
  "keyReminders": [
    ...
    "AI recommendation is not selection; Proposal becomes selected Decision/planning meaning only through normal authority, and under SDS unrealized selected meaning remains Evolution Step target state until realization/materialization.",
    "Ask a minimum grounding clarification only when material USER-only information/authority is actually required; do not manufacture questions or formal Proposal State for trivial/local candidate text.",
