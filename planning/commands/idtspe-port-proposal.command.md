# Include Idtspe Formal Idtspe Proposal Capability Port Capability
...
[PLANNING_COMMAND_DEFINITION]
{
  "schemaVersion": 1,
  "commandFamily": [
    "включи порт proposal"
  ],
  "description": "Check/traverse formal IDTSPE Proposal/Alternative work required by the current composition.",
  "meaning": "Require the named Proposal capability to receive a real applicability/traversal check in the current normal IDTSPE Shell pass. The command expresses an explicit semantic requirement; current Shell topology resolves it to the canonical port. A positive semantic result is not required.",
  "activeContextBehavior": "Compose into the current/next normal IDTSPE Shell pass. If equivalent Proposal work already exists for the same subject/basis/operation, reuse it instead of repeating it.",
  ...
  "palette": true,
  "refinements": [],
  "id": "idtspe.port.proposal",
  "file": "idtspe-port-proposal.command.md",
  "command": "включи порт proposal",
  ...
  "ownerRefs": [
    {
      ...
      "anchor": "idtspe-port-p07",
      "why": "Defines the canonical Shell connector for P-07 Proposal; the command explicitly requires this capability to receive a real check.",
      "role": "RUNTIME_ENTRY",
      "readMode": "REQUIRED"
    },
    {
      ...
      "why": "Defines formal IDTSPE Proposal candidate semantics, review and selection boundary.",
  ...
  "compositionContributions": [
    {
      ...
      "value": "PROPOSAL",
      "why": "Explicitly require the PROPOSAL capability to receive a real applicability/traversal check in the merged current Shell composition."
    }
  ]
}
[/PLANNING_COMMAND_DEFINITION]
