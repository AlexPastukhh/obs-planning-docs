...
[PLANNING_COMMAND_DEFINITION]
{
  ...
  "ownerFiles": [
    "planning/documentation/idtspe-methodology/active/idtspe-core/runtime/IDTSPE-DEFAULT-WORK-MODE.md",
  ...
  "ownerRefs": [
    {
      ...
      "why": "Keeps application-idea collection proportional and inside normal IDTSPE work instead of manufacturing structure.",
      "role": "PRIMARY_OWNER",
      "readMode": "REQUIRED"
    }
  ]
