...
[PLANNING_COMMAND_DEFINITION]
{
  ...
  "meaning": "Legacy alias for current Domain work. Treat supplied ideas as normal IDTSPE material. Use TM-DOMAIN-DISCOVERY for transient discovery; promote relevant meaning to TM-DOMAIN-OWNER only when independent durable Domain ownership becomes useful. Do not revive an Ideas accumulator or unified shallow/deep Domain Target family.",
