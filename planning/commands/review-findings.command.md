...
[PLANNING_COMMAND_DEFINITION]
{
  ...
  "description": "Produce an optional bounded Review Finding Analysis Target that separates evidence-backed observations from impact and escalation diagnosis.",
  "meaning": "Apply generic Core TM-REVIEW-FINDINGS only when a separately addressable diagnostic result is useful. Establish CURRENT_BASIS Review Coverage before Validation/Lens checks, then resolve RU-RFIND-01 observed Finding Candidates and RU-RFIND-02 canonical materiality, Review Priority, RE-* escalation, natural owner and USER-attention analysis. Hand material Findings to the Proposal lifecycle as a separate action. This diagnostic result does not by itself complete idtspe.review when linked Proposals remain pending.",
  ...
  "expectedOutput": "RU-RFIND-01 evidence-backed Finding Candidates and RU-RFIND-02 materiality/Review Priority/RE-* /natural-owner diagnosis with explicit Proposal handoff status; the canonical Review Coverage Record remains separate and full review completion waits for linked Proposals.",
  "permissionMode": "read-only-planning",
  "keyReminders": [
    "This is an optional Review Finding Analysis Target, not a mandatory Target for every review.",
    "Keep observations distinct from proposed corrections; Review Priority and RE-* answer different questions.",
  ...
  "ownerRefs": [
    ...
    },
    {
      ...
      "why": "Owns the optional bounded diagnostic Target result and the separate Finding discovery/analysis Units.",
      "role": "PRIMARY_OWNER",
      "readMode": "REQUIRED"
    },
    {
