...
[PLANNING_COMMAND_DEFINITION]
{
  ...
  "keyReminders": [
    ...
    "Current methodology owners in this repository retain authority; the copied application documents are dated examples.",
